  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4 flex-wrap mb-6">
        ...
        <button className={btnStyle} onClick={() => handleClick("Generate Tests")}>
          Generate Tests
        </button>
...
{loading ? (
  ...
  <ReactMarkdown
    ...
    components={{
      ...
      h2: ({ node, ...props }) => (
        <h2 {...props} className="text-xl font-bold mt-4 mb-2" />
      ),
      h3: ({ node, ...props }) => (
        <h3 {...props} className="text-lg font-semibold mt-3 mb-2" />
      ),
      h4: ({ node, ...props }) => (
        <h4 {...props} className="text-md font-semibold mt-3 mb-2" />
      ),
    }}
  >
    {output}
